...
const TileRepairs = () => {
  return (
    ...
    <img class='w-[40vw]' src="http://localhost:8080\cracked-floor-tile-2.jpeg" alt='Tile Repairing Image' />
    <div class='w-[50vw]'>
...
<div class="flex mx-auto p-8">
    ...
    <div class="flex-1 fit">
        <img className='h-[108vh] w-[100vh]' src="http://localhost:8080\Screenshot 2024-04-10 234141.png" alt="Big Image" />
    </div>
</div>
