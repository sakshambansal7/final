...
<div class="flex justify-center items-center space-x-4 p-4">
  <img src="/images/299-High-007-Resize.jpg" alt="Image 1" class="w-1/4 h-auto  shadow-md"/>
  <img src="/images/299-High-008-Resize.jpg" alt="Image 2" class="w-1/4 h-auto  shadow-md"/>
  <img src="/images/HP_SpudBAR-The-Glen_15_Full+resolution_8688x5792_U_100_Adobe_1920.jpg" alt="Image 3" class="w-1/4 h-auto  shadow-md"/>
  <img src="/images/Screenshot 2024-04-10 224847.png" alt="Image 4" class="w-1/4 h-auto  shadow-md"/>
</div>

<div className='second flex justify-between m-5 p-2  mt-20 gap-10'>
    <div className='fst-image'>

  <img className=' w-[46vw]'  src="/images/Screenshot 2024-04-10 234141.png" alt="" />
    </div>
  ...
  <div class="flex flex-wrap">
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Screenshot 2024-04-10 234314.png" alt="Image 1" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Screenshot 2024-04-10 234323.png" alt="Image 2" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Screenshot 2024-04-10 234336.png" alt="Image 3" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Screenshot 2024-04-10 234514.png" alt="Image 4" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/299-High-007-Resize.jpg" alt="Image 5" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/299-High-008-Resize.jpg" alt="Image 6" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Carvery-Club-Melton_07_2000x3000_U_100_Long+Edge_Scaled.jpg" alt="Image 7" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Carvery-Club-Melton_08_3000x2000_U_100_Long+Edge_Scaled.jpg" alt="Image 8" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Carvery-Club-Melton_16_3000x2000_U_100_Long+Edge_Scaled.jpg" alt="Image 9" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/Carvery-Club-Watergardens_17_3000x2000_U_100_Long+Edge1900.jpg" alt="Image 10" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/bakery (2).jpg" />
      </div>
    </div>
    <div class="w-1/4 p-2">
      <div class="aspect-w-1 aspect-h-1">
        <img src="/images/HP_SpudBAR-The-Glen_15_Full+resolution_8688x5792_U_100_Adobe_1920.jpg" alt="Image 12" class="object-cover w-full h-full rounded-lg" />
      </div>
    </div>
